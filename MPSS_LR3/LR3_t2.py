...
def runge_kutta(u, h, T):
    ...
    while t < T:
        ...
        u = np.nan_to_num(u)  # Замінюємо NaN на 0
        u = np.clip(u, -1e6, 1e6)  # Відсікаємо занадто великі або малі значення
